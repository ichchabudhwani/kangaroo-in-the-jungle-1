...
var kangaroo, kangaroo_running , kangaroo_collided, shrub1 ,shrub2, shrub3,shrub;
...
*/
kangaroo= createSprite(100,10,400,20);
kangaroo.addAnimation("kangaroo",kangaroo_running);
kangaroo.scale=0.2
kangaroo.y =height /2;
//kangaroo.setCollider("circle",10,10)
//Create a sprite for Invisible ground and place it at the bottom side of the screen.
shrub=createSprite(500,400,20,20);
//shrub.x =height /2;
shrub.addImage("shrubs",shrub3);
shrub.addImage("shrubs",shrub2);
shrub.addImage("shrubs",shrub1);

shrub.scale=0.1

invisibleGround=createSprite(550,550,200,10);
invisibleGround.visible=false
//invisibleGround.scale=0.1
invisibleGround.x =height /2;
...
//Set the x-position of the shrub according to the game camera.
  shrub.position.x=width/2
   shrub.x = -(6 + 3*score/100)
    //shrub.scale = 0.1;
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    var obstacle = createSprite(camera.position.y+300,400,40,40);
